...
if __name__ == '__main__':
    ...
    for city in cities:
        images = os.listdir("data/anti-deepfake-data and code/data/authentic/" + city)
        os.makedirs("data/anti-deepfake-data and code/data/authentic/" + city + "_128", exist_ok=True)
        for img in images:
            img_path = "data/anti-deepfake-data and code/data/authentic/"+ city+ "/" + img
            print(img_path)
